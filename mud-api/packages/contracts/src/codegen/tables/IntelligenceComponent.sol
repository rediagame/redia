...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("IntelligenceComp")));
bytes32 constant IntelligenceComponentTableId = _tableId;

library IntelligenceComponent {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("IntelligenceComponent", _fieldNames);
  }
