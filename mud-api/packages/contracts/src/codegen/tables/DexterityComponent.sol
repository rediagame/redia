...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("DexterityCompone")));
bytes32 constant DexterityComponentTableId = _tableId;

library DexterityComponent {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("DexterityComponent", _fieldNames);
  }
