...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("DefenseComponent")));
bytes32 constant DefenseComponentTableId = _tableId;

library DefenseComponent {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("DefenseComponent", _fieldNames);
  }
