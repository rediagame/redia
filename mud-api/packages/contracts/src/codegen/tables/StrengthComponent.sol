...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("StrengthComponen")));
bytes32 constant StrengthComponentTableId = _tableId;

library StrengthComponent {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("StrengthComponent", _fieldNames);
  }
