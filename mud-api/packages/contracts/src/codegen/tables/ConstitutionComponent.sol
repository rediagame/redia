...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("ConstitutionComp")));
bytes32 constant ConstitutionComponentTableId = _tableId;

library ConstitutionComponent {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("ConstitutionComponent", _fieldNames);
  }
