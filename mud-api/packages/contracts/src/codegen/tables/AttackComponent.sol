...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("AttackComponent")));
bytes32 constant AttackComponentTableId = _tableId;
...
library AttackComponent {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("AttackComponent", _fieldNames);
  }
